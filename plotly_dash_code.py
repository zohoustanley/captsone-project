...
for launchSiteValue in pd.Series(spacex_df['Launch Site']).unique():
    siteOptions.append({'label': launchSiteValue, 'value': launchSiteValue})
...
def get_pie_chart(entered_site):
    if entered_site == 'ALL':
        ...
        filtered_df = spacex_df[spacex_df['Launch Site'] == entered_site].reset_index(drop=True)
...
def get_pie_chart_by_payload(entered_site, payload_value):
    if entered_site == 'ALL':
